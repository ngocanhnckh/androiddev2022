...
public class WeatherAndForecast extends Fragment {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState){
        WeatherFragment fa1 = new WeatherFragment();
        ForecastFragment fa2 = new ForecastFragment();
        getChildFragmentManager().beginTransaction().add(R.id.child_fragment_container, fa1).add(R.id.child_fragment_container, fa2).commit();
    }
}